...
public class GameManager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        DiamondIcon.transform.localScale = Vector3.LerpUnclamped(DiamondIcon.transform.localScale, Vector3.one * 1.25f, 0.15f);
    ...
    public void CollectByTap(Vector3 tapPosition, Transform parent)
    {
        ...
        DiamondIcon.transform.localScale = Vector3.one * 1.75f;
